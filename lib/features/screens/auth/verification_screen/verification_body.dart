    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Text("Enter verification code", style: AppTextStyles.textLarge),
          SizedBox(height: 10),
          Text("We have sent to 01098765432", style: AppTextStyles.textSmall),
          SizedBox(height: 30),
          Row(
            children: [
              OTPItem(),
          ...
          Row(
            ...
            children: [
              Text('Resend OTP', style: AppTextStyles.textSmallRed),
              Text('Change phone number', style: AppTextStyles.textSmall),
            ],
          ),
          SizedBox(height: 40),
